...
const ProjectItem = ({ img, title, href, stack }) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full shadow-lg shadow-[#4c85e6] rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e] hover:scale-110'>
      <img src={img} alt='/' className='h-full rounded-xl group-hover:opacity-10' />
